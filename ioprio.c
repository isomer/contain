...
static struct argp_option ioprio_options[] = {
    {"iort",       10, "priority", 0, "Set IO Realtime priority level", 0},
    {"iobe",       11, "priority", 0, "Set IO Besteffort priority level", 0},
    {"ioidle",     12, "priority", 0, "Set IO Idle priority level", 0},
    {NULL,	   0,   0, 0, NULL, 0 },
};
